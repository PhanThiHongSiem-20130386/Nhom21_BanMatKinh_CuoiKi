                        ...
                        <form action="edit-profile">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control"
                                           ...
                                           placeholder="Enter your first name" value="<%=a1.getFullName()%>">
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control"
                                       ...
                                       placeholder="Enter your email address" value="<%=a1.getPass()%>">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control"
                                       ...
                                       placeholder="Enter your email address" value="<%=a1.getEmail()%>">
                            </div>
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control"
                                           ...
                                           placeholder="Enter your location" value="<%=a1.getAddress()%>">
                                </div>
                            </div>
                            <!-- Form Row-->
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control"
                                           ...
                                           placeholder="Enter your phone number" value="<%=a1.getPhone()%>">
                                </div>
                                <!-- Form Group (birthday)-->
